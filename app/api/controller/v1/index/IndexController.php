...
class IndexController
{
    ...
    {
        $banner = sys_data('mini_home_banner') ?: []; //TODO 首页banner图

        $directorMembeServices = app()->make(DirectorMembeServices::class);
        $directorList = $directorMembeServices->newList();

        return app('json')->success(compact('banner','directorList'));
    }
