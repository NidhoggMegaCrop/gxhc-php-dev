...
Route::group('pc', function () {
    ...
    Route::group(function () {
        ...
        ->middleware(\app\home\middleware\StationOpenMiddleware::class)
    ...
    Route::group(function () {
        ...
        ->middleware(\app\home\middleware\StationOpenMiddleware::class)
        ->middleware(\app\home\middleware\AuthTokenMiddleware::class, false)
    ...
    Route::group(function () {
        ...
        ->middleware(\app\home\middleware\StationOpenMiddleware::class)
        ->middleware(\app\home\middleware\AuthTokenMiddleware::class, true)
