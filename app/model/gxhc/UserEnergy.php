 ...
 */
class UserEnergy extends BaseModel
{
    use ModelTrait;
    ...
    /**
     * 关联订单表
     * @return UserEnergy|model\relation\HasOne
     */
    public function order()
    {
        return $this->hasOne(BpOrder::class, 'id', 'link_id')->field(['id', 'total_num'])->bind(['total_num']);
    }
