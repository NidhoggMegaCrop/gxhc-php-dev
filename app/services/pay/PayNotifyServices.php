...
class PayNotifyServices
{
     ...
     */
    public function wechatBp(string $order_id = null, string $trade_no = null, string $payType = PayServices::WEIXIN_PAY)
    {
        try {
            /** @var BpOrderSuccessServices $services */
            $services = app()->make(BpOrderSuccessServices::class);
