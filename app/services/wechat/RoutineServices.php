...
class RoutineServices extends BaseServices
{
     ...
     * @throws \think\db\exception\ModelNotFoundException
     */
    public function authBindingPhone($code, $iv, $encryptedData, $spread, $spid, $scene, $key = '')
    {
        $wechatInfo = [];
        ...
        // $userInfoCong = ['session_key'=>'','openid'=>''];
        // $userInfo = ['purePhoneNumber' => '15574214151'];
        ...
        if ($scene && ($info = $qrcode->getOne(['id' => $scene, 'status' => 1]))) {
