    ...
    public function wechatOauthAfter($data)
    {
        ...
        if ($userInfo) {
            ...
            $userInfo = $this->transaction(function () use ($userServices, $wechatInfo, $spreadId, $userType) {
                ...
                // if ((int)$spreadId && !empty($wechatInfo['uid'])) {
                //     $invite_uid = (int)$spreadId;
                ...
                //         return $userInfo;
                //     }
                //     $currer_user = $userService->getUserInfo((int)$wechatInfo['uid']);
                //     if (empty($currer_user['spread_uid'])) {
                //         $userService->update($wechatInfo['uid'], ['spread_uid' => $invite_uid], 'uid');
